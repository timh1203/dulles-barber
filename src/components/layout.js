    ...
    render={data => (
      <>
        <Helmet
          ...
          meta={[
            { name: 'description', content: "Home page for Dulles Barber Shop located in Ashburn and Sterling, Virginia servicing men and children haircut needs. See address, hours, and contact information" },
            { name: 'keywords', content: "barber, barbershop, men, children, haircuts, flat top, skin fade, shampoo and cut, shear cut, head shave, beard trims, beard shaves, special cuts, ashburn, sterling, virginia" },
